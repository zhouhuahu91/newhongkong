    ...
    >
      <div className="flex items-center space-x-3 justify-between">
        <div className="flex items-center space-x-3">
          ...
          {/* We can delete orders if the order is placed by an admin or... */}
          {/* ... order is placed but but payment process is never finished */}
          {(order.email.toLowerCase() === "test@test.com" ||
            (Date.now() > order.createdAt + 300000 &&
