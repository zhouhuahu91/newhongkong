    ...
    <div className={`flex flex-col w-full ${wrapper && wrapper}`}>
      ...
      <div className="relative">
        <input
          ...
          id={name}
          className={`appearance-none my-0.5 border rounded-lg w-full text-sm hover:shadow-sm hover:scale-[1.04] transition-all focus:scale-[1.04] focus:outline-none bg-inherit focus:shadow-sm py-2 placeholder-gray-300 ${
